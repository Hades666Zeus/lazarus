jQuery(document).ready(function ($) {
	...
	function showLetter($letter, $word, $bool, $duration) {
		...
		if ($("b:nth-child(3) i").hasClass("in")) {
			$(".circle svg circle ").css("fill", "#000000");
		}
		if ($("b:nth-child(2) i").hasClass("in")) {
			$(".circle svg circle ").css("fill", "#FFE000");
		}

		if ($("b:nth-child(1) i").hasClass("in")) {
			$(".circle svg circle ").css("fill", "#000000");
		}
